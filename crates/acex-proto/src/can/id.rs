...
impl StandardCanId {
    ...
    pub fn new(val: u16) -> Result<Self, acex_core::DiagError> {
        if val > Self::MAX {
            Err(acex_core::DiagError::InvalidFrame(acex_core::diag_err_str(
...
impl ExtendedCanId {
    ...
    pub fn new(val: u32) -> Result<Self, acex_core::DiagError> {
        if val > Self::MAX {
            Err(acex_core::DiagError::InvalidFrame(acex_core::diag_err_str(
