...
impl From<acex_core::DiagError> for UdsError {
    fn from(e: acex_core::DiagError) -> Self {
...
impl From<UdsError> for acex_core::DiagError {
    fn from(e: UdsError) -> Self {
        match e {
            UdsError::Transport(diag) => diag,
            UdsError::Parse(msg) => acex_core::DiagError::InvalidFrame(msg),
            UdsError::NegativeResponse(nrc) => acex_core::DiagError::InvalidFrame(
                format!("negative response: {nrc}").unwrap_or_default(),
            ),
            UdsError::ResponsePending => acex_core::DiagError::InvalidFrame(
                heapless::String::try_from("response pending").unwrap_or_default(),
            ),
            UdsError::Validation(e) => acex_core::DiagError::InvalidFrame(
