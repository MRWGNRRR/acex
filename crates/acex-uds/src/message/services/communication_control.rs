...
impl<'a> acex_core::codec::FrameRead<'a> for CommunicationType {
    type Error = UdsError;
...
impl acex_core::codec::FrameWrite for CommunicationType {
    type Error = UdsError;
    fn encode<W: acex_core::Writer>(&self, buf: &mut W) -> Result<(), Self::Error> {
