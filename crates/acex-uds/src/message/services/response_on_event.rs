use acex_core::{DiagError, FrameIter, FrameRead, FrameWrite};
...
impl<'a> acex_core::codec::FrameRead<'a> for ResponseOnEventRequest<'a> {
    type Error = UdsError;
...
impl acex_core::codec::FrameWrite for ResponseOnEventRequest<'_> {
    type Error = UdsError;
