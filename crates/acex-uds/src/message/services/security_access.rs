...
use acex_core::{DiagError, FrameWrite};
...
impl<'a> acex_core::codec::FrameRead<'a> for SecurityAccessResponse<'a> {
    type Error = UdsError;
...
impl<'a> acex_core::codec::FrameRead<'a> for SecurityAccessRequest<'a> {
    type Error = UdsError;
